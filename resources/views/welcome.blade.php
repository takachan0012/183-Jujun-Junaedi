            ...
            <div class="w-11/12 navbar bg-base-100 border-[1px] border-[#ffffff1a] p-4 my-4 rounded-full">
                ...
                <div class="navbar-end">
                    <a href={{ route('registerPage') }}>
                        <x-button class="btn md:w-full w-24 btn-primary lg:justify-center">
                            <span class="hidden md:block">Launch the App</span>
                            <span class="md:hidden">Launch</span>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                stroke-width="1.5" stroke="currentColor" class="w-6 h-6 hidden md:block">
        ...
        <div class="flex flex-col md:mx-9">
                ...
                <div class="w-full flex flex-col-reverse md:flex-row md:justify-between items-center">
                    <div class="w-full md:w-1/2 flex flex-col gap-2">
                        <span
                            ...
                            Expenses</span>
                        <p>
                            Simplify your financial tracking and take control of your finances effortlessly with
                            Kuncikas.
                            Whether
                        ...
                        <a href={{ route('register') }} class="w-36 my-7">
                            <x-button class="btn btn-primary lg:justify-center">Sign Up</x-button>
                        </a>
                    </div>
            ...
            <div id="about" class="my-4 px-4 md:p-11 flex justify-center">
                <div
                    ...
                    <p>Your go-to solution for hassle-free bookkeeping. Say goodbye to complex spreadsheets
                        and
                        overwhelming financial software. With Kuncikas, managing your income, expenses, and more is as
                        easy
                        as a
                        few
                    ...
                    <ul class="flex flex-col gap-4 list-image-[url(checkmark.png)]">
                        ...
                        <li class="flex gap-4 items-center md:gap-2 ">
                            ...
                            <div>
                                ...
                                <p>Tailor your financial categories to suit your needs, making organization a breeze.
                                </p>
                            </div>
                        </li>
                        <li class="flex gap-4 items-center md:gap-2 ">
                            ...
                            <div>
                                ...
                                <p>Gain valuable insights into your spending habits and financial trends with our
                                    intuitive
                                    reporting
                                    tools.</p>
                            </div>
            ...
            <div id="testimonials" class="my-11 px-4 md:p-11 flex flex-col md:flex-row items-center gap-2">
                ...
                <div
                    ...
                    <p>
                        Since using Kuncikas, I've saved countless hours on bookkeeping. It's intuitive, user-friendly,
                        and
                        has
                ...
                <div
                    ...
                    <span class="text-2xl font-bold">"</span>
                    <p>
                        As a freelancer, staying on top of my finances is crucial. Kuncikas has made it incredibly easy
                        to
                        track
                        my
            ...
            <footer class="mb-7 px-4 md:p-11 flex flex-col md:flex-row gap-2 md:items-center">
                <div class="flex flex-col">
                    <span>Join thousands of satisfied users and experience the simplicity of Kuncikas for
                        yourself.</span>
                ...
                <a href={{ route('register') }}>
                    <x-button class="btn btn-primary w-32 lg:justify-center">Sign Up
                        Now!</x-button>
                </a>
            </footer>
        </div>
